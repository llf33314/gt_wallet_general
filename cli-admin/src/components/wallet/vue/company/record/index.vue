  ...
  <div>
    <div class="table-top-conent">
      ...
      <div>
        ...
        <el-date-picker v-show="tType==0" :clearable="false" format="yyyy-MM-dd" v-model="value" @change="selectDraw" type="datetimerange"
          :picker-options="pickerOptions2" placeholder="选择时间范围" align="right" style="width:250px;">
        </el-date-picker>
        <el-date-picker v-show="tType==1" :clearable="false" format="yyyy-MM-dd" v-model="value2" @change="selectDraw2" type="datetimerange"
          :picker-options="pickerOptions2" placeholder="选择时间范围" align="right" style="width:250px;">
        </el-date-picker>
      </div>
    </div>
    <div v-show="tType==0">
      <el-table ref="multipleTable" :data="payOrderList.records" class="public-top20">
        ...
        <el-table-column prop="amount" label="消费金额（元）" show-overflow-tooltip align="center">
        </el-table-column>
        <el-table-column prop="fee" label="交易手续费用（元）" show-overflow-tooltip align="center">
        </el-table-column>
      ...
      <div class="public-top20">
        <div class="public-fr">
          <el-pagination @current-change="handleCurrentChange" current-page.sync="payOrderList.pages" :page-size="10" layout="prev, pager, next, jumper"
            :total="payOrderList.total">
          </el-pagination>
        </div>
      </div>
    </div>
    <div v-show="tType==1">
      ...
      <div class="public-top20">
        <div class="public-fr">
          <el-pagination @current-change="handleCurrentChange2" current-page.sync="getDrawCashList.pages" :page-size="10" layout="prev, pager, next, jumper"
            :total="getDrawCashList.total">
          </el-pagination>
        </div>
      </div>
    </div>
