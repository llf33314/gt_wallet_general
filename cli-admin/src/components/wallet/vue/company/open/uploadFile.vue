    ...
    <div class="public-content">
      ...
      <el-form :model="ruleForm4" :rules="rules4" ref="ruleForm4" label-width="170px" class="demo-ruleForm">
        <el-form-item label="营业执照：" prop="doBusinessUrl">
          <el-upload class="avatar-uploader" ref="identitycardUrl1" action="" style="float:left" :multiple="true" :show-file-list="false" :http-request="uploadImgDoBusinessUrl" :before-upload="beforeAvatarUpload">
        ...
        <el-form-item label="开户许可证：" prop="licenseUrl">
          <el-upload class="avatar-uploader" ref="licenseUrl" action="" style="float:left" :multiple="true" :show-file-list="false" :http-request="uploadImgLicenseUrl" :before-upload="beforeAvatarUpload">
        ...
        <el-form-item label="身份证正面：" prop="identitycardUrl1">
          <el-upload class="avatar-uploader" ref="identitycardUrl1" action="" style="float:left" :multiple="true" :show-file-list="false" :http-request="uploadImgIdentitycardUrl1" :before-upload="beforeAvatarUpload">
        ...
        <el-form-item label="身份证背面：" prop="identitycardUrl2">
          <el-upload class="avatar-uploader" ref="identitycardUrl2" action="" style="float:left" :show-file-list="false" :http-request="uploadImgIdentitycardUrl2" :before-upload="beforeAvatarUpload">
