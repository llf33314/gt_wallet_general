 ...
 */
package com.gt.wallet.utils.alipay;

import java.util.Map;

import com.alipay.api.internal.util.StringUtils;
import com.gt.wallet.constant.alipay.AlipayServiceEventConstants;
import com.gt.wallet.constant.alipay.AlipayServiceNameConstants;
import com.gt.wallet.exception.BusinessException;
import com.gt.wallet.utils.alipay.executor.ActionExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayAsyncMsgSendExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayChatTextExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayDIYQRCodeEnterExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayDefaultExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayEnterExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayFollowExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayUnFollowExecutor;
import com.gt.wallet.utils.alipay.executor.InAlipayVerifyExecutor;
...
public class Dispatcher {
     ...
     */
    public static ActionExecutor getExecutor(Map<String, String> params) throws BusinessException {
        //获取服务信息
        String service = params.get("service");
        if (StringUtils.isEmpty(service)) {
            throw new BusinessException("无法取得服务名");
        }
        //获取内容信息
        String bizContent = params.get("biz_content");
        if (StringUtils.isEmpty(bizContent)) {
            throw new BusinessException("无法取得业务内容信息");
        }
        ...
        if (StringUtils.isEmpty(msgType)) {
            throw new BusinessException("无法取得消息类型");
        }
    ...
    private static ActionExecutor getEventExecutor(String service, JSONObject bizContentJson)
        ...
        if (StringUtils.isEmpty(eventType)) {
            throw new BusinessException("无法取得事件类型");
        }
