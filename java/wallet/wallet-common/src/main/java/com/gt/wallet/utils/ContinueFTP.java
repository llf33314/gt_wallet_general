...
public class ContinueFTP
{
    ...
    public Map<String, Object> download(String local)
            throws Exception
    {
        connect(WalletWebConfig.getFtpIp(), CommonUtil.toInteger(WalletWebConfig.getFtpPort()), WalletWebConfig.getFtpUser(),WalletWebConfig.getFtpPassword());
        Boolean is_connect=connect(WalletWebConfig.getFtpIp(), CommonUtil.toInteger(WalletWebConfig.getFtpPort()), WalletWebConfig.getFtpUser(),WalletWebConfig.getFtpPassword());
