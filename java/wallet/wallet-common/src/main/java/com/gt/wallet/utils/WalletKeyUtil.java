 ...
 *
 */
public class WalletKeyUtil {
	
	private static String strDefaultKey = "walletKey";  
     ...
     * @throws Exception 
     */  
    public WalletKeyUtil() throws Exception {  
        this(strDefaultKey);  
    }  
    
    static{
    	try {
			new WalletKeyUtil(strDefaultKey);
		} catch (Exception e) {
			e.printStackTrace();
		}
    }
	...
	public WalletKeyUtil(String strKey) throws Exception {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        String str3 = "2";  
//        // DES加密  
//        WalletKeyUtil keysUtil=new WalletKeyUtil();
  
        String str2 =WalletKeyUtil.getEncString(str1);  
        String str4 =WalletKeyUtil.getEncString(str3);  
        String deStr = WalletKeyUtil.getDesString(str2);  
