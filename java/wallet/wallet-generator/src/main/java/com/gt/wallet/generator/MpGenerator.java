package com.gt.wallet.generator;
...
public class MpGenerator {
    ...
    // 项目的绝对路径
    public static final  String   outPutBaseDir      = "D:/workspace-sts-3.7.3.RELEASE/wallet/";
    // 生成*.java 的文件路径
    ...
    public static final  String   generatorXmlPath   = outPutBaseDir + "wallet-dao/src/main/resources/mapper/log/";
    ...
    // url
    public static final  String   url                = "jdbc:mysql://113.106.202.51:3306/gt_wallet?characterEncoding=utf8";
    // 数据库用户名
    public static final  String   username           = "root";
    // 密码
    public static final  String   password           = "gt123456";
    // 作者
    private static final String   author             = "lifengxi(gt_sky@qq.com)";
	...
	AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
			...
			new StrategyConfig()
					...
					// 自定义 service 父类
					.setSuperServiceClass( "com.gt.wallet.base.BaseService" )
					// 自定义 service 实现类父类
					.setSuperServiceImplClass( "com.gt.wallet.base.BaseServiceImpl" )
					// 自定义 controller 父类
					.setSuperControllerClass( "com.gt.wallet.base.BaseController" )
