 ...
 * @version 创建时间：2017年11月17日 下午3:06:21 数据源配置类，包括事务管理，dao、biz层监控
 */
@Configuration
@Slf4j
public class DruidDataSourceConfig {
	...
	public ServletRegistrationBean druidStatViewServle() {
		...
		ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(new StatViewServlet(),
				URL_MAPINGS);
		// 添加初始化参数：initParams
		log.debug("Druid 白名单IP：{} , 黑名单IP：{} , 登录账号/密码：{}/{} , 是否开启重置数据：{} ", ALLOW, DENY, LOGIN_USERNAME,
				LOGIN_PASSWORD, RESETENABLE);
