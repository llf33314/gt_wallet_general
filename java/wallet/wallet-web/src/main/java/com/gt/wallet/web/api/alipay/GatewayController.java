...
import com.gt.wallet.utils.alipay.Dispatcher;
 ...
 * @version 创建时间：2017年12月19日 上午10:01:34 类说明
 */
@Slf4j
@Controller
...
public class GatewayController {
	...
	public void gateway(HttpServletRequest request, HttpServletResponse response)
		...
		log.info(CommonUtil.format("支付宝请求串 %s", params.toString()));
		...
		try {
			...
			try {
				...
				// 开发者自行决定是否要记录，视自己需求
				log.info(CommonUtil.format("开发者响应串：%s", responseMsg));
