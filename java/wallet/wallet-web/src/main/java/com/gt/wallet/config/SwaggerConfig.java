...
public class SwaggerConfig {
    ...
    // 标题
    private static final String  TITLE               = "多粉钱包 API";
    // 描述
    private static final String  DESC                = "多粉钱包";
    // 版本
    private static final String  VERSION             = "1.0.0";
    //
    private static final String  TERMS_OF_SERVICEURL = "NO terms of service";
    // 作者信息
    private static final Contact CONTACT             = new Contact( "lifengxi", "http://www.lx691.com", "3001354690@qq.com" );
    //
